...
#     conversions = {
#         "Length": {
#             "meters": 1, "kilometers": 0.001, "miles": 0.000621371, "feet": 3.28084, "inches": 39.3701, "centimeters": 100, "millimeters": 1000, "yards": 1.09361
#         },
#         "Weight": {
...
#         },
#         "Volume": {
#             "liters": 1, "milliliters": 1000, "gallons": 0.264172, "quarts": 1.05669, "pints": 2.11338, "cups": 4.16667, "fluid ounces": 33.814
#         }
#     }
    
#     if category == "Temperature":
#         return conversions[category][to_unit](value) if from_unit == "Celsius" else (
#             (value - 32) * 5/9 if from_unit == "Fahrenheit" and to_unit == "Celsius" else
#             ((value - 32) * 5/9) + 273.15 if from_unit == "Fahrenheit" and to_unit == "Kelvin" else
#             value - 273.15 if from_unit == "Kelvin" and to_unit == "Celsius" else
#             ((value - 273.15) * 9/5) + 32 if from_unit == "Kelvin" and to_unit == "Fahrenheit" else value
#         )
#     else:
...
#     "Weight": ["grams", "kilograms", "pounds", "ounces", "milligrams", "stones", "tons"],
...
#         },
#         "Time": {
#             "seconds": 1, "milliseconds": 1000, "microseconds": 1000000, "nanoseconds": 1000000000, "minutes": 0.0166667, "hours": 0.000277778, "days": 0.0000115741, "weeks": 0.0000016534, "months": 3.8027e-7, "years": 3.1689e-8, "decades": 3.1689e-9, "centuries": 3.1689e-10
#         }
#     }
...
# category = st.selectbox("Select Category", ["Length", "Weight", "Temperature", "Volume", "Area", "Data Transfer Rate", "Digital Storage", "Energy", "Frequency", "Fuel Economy", "Plane Angle", "Pressure", "Speed", "Time"])
...
#     "knot": 1.94384,  # 1 m/s ≈ 1.94384 knots (rounded to 5 decimal places)
...
#     "knot_to_speed_of_light": 1.7165e-9  # 1 knot ≈ 1.7165 × 10⁻⁹ c (derived from 0.514444 m/s per knot)
# },
#     # "Speed": {
#     #     "m/s": 1, "km/h": 3.6, "mph": 2.23694, "knots": 1.94384
#     # },
...
#                 ((value - 32) * 5/9) * 4/5 if to_unit == "Reaumur" else
#                 (((value - 32) * 5/9) * 21/40) + 7.5 if to_unit == "Romer" else
#                 value
#             )
...
#                 (value - 273.15) * 4/5 if to_unit == "Reaumur" else
#                 ((value - 273.15) * 21/40) + 7.5 if to_unit == "Romer" else
#                 value
#             )
...
#                 ((value - 491.67) * 5/9) * 4/5 if to_unit == "Reaumur" else
#                 (((value - 491.67) * 5/9) * 21/40) + 7.5 if to_unit == "Romer" else
#                 value
#             )
...
#                 (100 - (value * 2/3)) * 4/5 if to_unit == "Reaumur" else
#                 (((100 - (value * 2/3)) * 21/40) + 7.5) if to_unit == "Romer" else
#                 value
#             )
#         else:
...
# from_unit = st.selectbox("From", units[category])
# to_unit = st.selectbox("To", units[category])
# value = st.number_input("Enter Value", value=1, min_value=1, step=1)

# if st.button("Convert"):
#     result = convert_units(value, from_unit, to_unit, category)
#     st.success(f"{value} {from_unit} is equal to {int(result)} {to_unit}")
